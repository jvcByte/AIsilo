          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    AES-256-GCM encryption (NSA Suite B approved algorithm)
                    combined with blockchain verification provides strong
                    protection for your sensitive files.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Files are stored on IPFS with metadata recorded on
                    blockchain. Cloudflare Workers secure presigned URLs,
                    keeping JWT tokens server-side.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    ...
                    files, with no third-party involvement.
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="text-center">
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-4">
                    Files are encrypted with 256-bit AES encryption before
                    storage. Only you control the decryption keys.
                  </p>
              ...
              <Card className="text-center">
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-4">
                    Blockchain verification ensures files cannot be tampered
              ...
              <Card className="text-center">
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-4">
                    IPFS distributed storage ensures your files are always
                ...
                <CardContent className="space-y-4">
                  <div className="bg-muted p-4 rounded-lg font-mono text-sm">
                    <div className="space-y-2">
                      ...
                      <div>
                        2. Derive key: Keccak256(signature) → 32-byte AES key
                      </div>
                      ...
                      <div>
                        6. Upload encrypted file to IPFS via presigned URL
                      </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Keccak256 hash of wallet signature
                      </p>
                    </div>
                    <div>
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-mono text-xs">
                          0x41c88BE9a1A761657E7B4569b89C5A20700F9f8A
                        </span>
                      </div>
                    </div>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm text-muted-foreground">
                      <li>
                        • uploadDocument(docID, cid) - Register new document
                      </li>
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Design aligns with: Access Enforcement, Cryptographic
              ...
              <Card>
                ...
                <CardContent className="space-y-2 text-sm text-muted-foreground">
                  <p className="text-xs italic mb-2">
                    Architecture aligns with these controls (not certified):
                  </p>
