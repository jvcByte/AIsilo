...
import { Download, FileText, Lock, AlertTriangle, PenTool, CheckCircle2, Loader2 } from 'lucide-react';
...
export function DownloadFile() {
    ...
    const handleDownload = async () => {
        ...
        try {
            ...
            if (!response.ok) {
                toast.error(`Failed to fetch from Pinata API: ${response.status} ${response.statusText}`, {
                    className: "toast-error"
                });
                return;
            }
    ...
    return (
        <div className="container mx-auto p-4">
            <div className="flex items-center gap-2 mb-6">
                ...
                <h1 className="text-2xl font-bold text-foreground">Decrypt & Download File</h1>
            </div>
                        ...
                        <CardContent>
                            <div className="space-y-4">
                                <Alert>
                                    ...
                                    <AlertDescription>
                                        Message signed successfully. Ready to decrypt and download your file.
                                    </AlertDescription>
                                </Alert>
