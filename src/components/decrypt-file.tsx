          ...
          <Card className="bg-gradient-to-br from-muted to-background">
            ...
            <CardContent>
              <div className="space-y-4">
                <div>
                  <Label htmlFor="encrypted" className="text-foreground">
                    Encrypted Data (Hex)
                  </Label>
                  <Input
                    id="encrypted"
                ...
                <div>
                  <Label htmlFor="iv" className="text-foreground">
                ...
                <div>
                  <Label htmlFor="mimeType" className="text-foreground">
                    MIME Type
                  </Label>
                  <Input
                    id="mimeType"
          ...
          {(encryptedData || iv || fileName || mimeType) && !signature && (
            <Card className="bg-gradient-to-br from-muted to-background">
              ...
              <CardContent>
                <div className="space-y-4">
                  <p className="text-muted-foreground">
                    To decrypt your file, please sign this message with your
                    wallet:
                  </p>
                  ...
                  <div className="p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                    <div className="flex items-center gap-2">
                      ...
                      <Badge variant="secondary">
                        {(decryptedFile.size / 1024).toFixed(2)} KB
                      </Badge>
                    </div>
                  </div>
